...
examples are returned as L<Test::Auto::Try> objects, this makes capturing and
...
result as a L<Test::Auto::Try> object. The first argument is the example ID (or
  number), for example:
...
result as a L<Test::Auto::Try> object, for example:
